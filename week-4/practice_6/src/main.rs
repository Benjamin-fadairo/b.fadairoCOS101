fn main() {
    ...
    println!("\nThe {} is informed by the aspiration to train electrica/electronic engineering proffesionals in the areas of design, building and maintenance of electrical control systems,",n4);
